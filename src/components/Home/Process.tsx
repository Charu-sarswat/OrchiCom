          ...
          <div className={styles.contentColumn}>
            ...
            <div className={styles.actions}>
              <Link href="https://wa.me/917080803074" className={styles.whatsappBtn}>
                <svg viewBox="0 0 24 24" width="22" height="22" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round"><path d="M21 11.5a8.38 8.38 0 0 1-.9 3.8 8.5 8.5 0 1 1-7.6-11.7 8.5 8.5 0 0 1 7.6 11.7l1.7 3-3-1.7Z"/></svg>
                Chat On WhatsApp
              </Link>
